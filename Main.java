...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        saveGame("B://Games//savegames//game1.dat", game1);
        saveGame("B://Games//savegames//game2.dat", game2);
        saveGame("B://Games//savegames//game3.dat", game3);
        ArrayList<String> arrayList = new ArrayList<>();
        arrayList.add("B://Games//savegames//game1.dat");
        arrayList.add("B://Games//savegames//game2.dat");
        arrayList.add("B://Games//savegames//game3.dat");
        zipFiles("B://Games//savegames//zip.zip", arrayList);
        File game1Dat = new File("B://Games//savegames//game1.dat");
        File game2Dat = new File("B://Games//savegames//game2.dat");
        File game3Dat = new File("B://Games//savegames//game3.dat");
